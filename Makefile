...
#CFLAGS = -Wall -g -std=c99 -pthread -lrt -Werror -D_POSIX_C_SOURCE=199309L
#CCFLAGS= -g -std=c99 -pthread -lrt -D_POSIX_C_SOURCE=199309L
CFLAGS = -Wall -g -std=c99 -pthread -lrt -D_POSIX_C_SOURCE=199309L
